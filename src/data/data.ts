...
export const projects = [
  {
    ...
    details: {
      ...
      improvements:
        "데이터를 직접 입력하는 게 아니라 블로그처럼 사이트에서 입력, 수정, 삭제가 가능하게 구현해보면 더 좋을 것 같습니다. 이 경우, 사용자 별 권한 관리가 필요하고, 데이터를 저장하고 불러올 서버 기능이 필요합니다.",
    },
  },
  {
    title: "쇼핑몰",
  ...
  },
  {
    ...
    details: {
      ...
      result:
        "이번 프로젝트를 통해 협업 과정에서의 효과적인 커뮤니케이션과 컨벤션 설정의 중요성을 깨달았습니다. 또한, Next.js와 TypeScript, Tailwind CSS의 조합을 활용한 개발에서 성능 최적화와 사용자 경험 향상에 대해 많은 것을 배울 수 있었습니다. API 통합 및 관리에 있어서 TanStack Query를 활용한 서버 상태 관리 기법을 익혔습니다.",
      improvements:
        "서로 글을 적고 소통할 수 있는 커뮤니티 게시판과 실시간 대화방 기능을 추가로 구현한다면 사용자들의 참여와 교류를 더욱 이끌어낼 수 있을 것 같습니다. 또한 더 복잡한 사용자 인증 시스템을 도입해 실서비스의 기능과 로직들을 구현해보면 좋을 것 같습니다.",
    },
  },
];
